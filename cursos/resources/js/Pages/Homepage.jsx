                ...
                <div className="skills-container">
                    ...
                    <div className="skills-block">
                        ...
                        <div className="skills-content-right">
                            <h3 className="skills-title">Laravel + Filament</h3>
                            <p className="skills-description">
                                Train like an athlete with top-tier equipment
                                and expert programming. Whether you're building
                                mass, dropping fat, or just want to push past
                                limits.
                            </p>
                            <div>
                                <Link
                                ...
                                >
                                    <span className="skills-link-text">
                                        VER MAIS
                                    </span>
                                    <svg
                                        className="skills-link-icon"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                    ...
                    <div className="skills-block">
                        <div className="skills-content-left">
                            <h3 className="skills-title">React.js Avançado</h3>
                            <p className="skills-description">
                                Train like an athlete with top-tier equipment
                                and expert programming. Whether you're building
                                mass, dropping fat, or just want to push past
