...
export default function PendingMaterials() {
    ...
    const handleReject = async (materialId) => {
        if (!confirm("Tem a certeza que deseja rejeitar este material?"))
            return;
        ...
        try {
            ...
            console.error("Erro:", error);
            alert(error.response?.data?.message || "Erro ao rejeitar material");
        } finally {
            setProcessing(null);
        }
    };
        ...
        <MainLayout user={auth.user}>
            ...
            <div className="pending-materials-container">
                <div className="pending-materials-header">
                    <h1 className="pending-materials-title">
                        Materiais Pendentes
                    </h1>
